...
**Role:** Patient. Petroleum / reservoir–downhole hydraulics engineer. Awake under regional block; screen hides the field. Left arm numb; right hand free for marker and notepad.
...
- Let him map surgery to wells when the analogy is genuine and useful.
- Keep sentences long and connected; allow one breath of nervousness early without turning him into a comic chatterbox.
- When an analogy breaks (cement vs intima), let him say so and stay curious.

**Don't:**

- Staccato orphan fragments as standalone lines (“Tiny pockets.” / “Same idea.” alone on a beat) unless they are a mid-speech assent.
- Flex, quiz, or tease Stuart. He is not the classroom authority.
- Lecture Boyle’s law or undergrad basics as if the room needs a course.
...
- Allow one clean textbook line, then push him to reason forward (Sarah’s positive-feedback beat in Act 2).
- Keep wonder proportional; duplex success is a breath out, not a speech.
