...
| [`accident.md`](accident.md) | Workshop scene | `accident_sketch.png` | **Needs regen** (ulnar wound; discrete pulse) |
...
Medical plates link to [`medical_shared_style.md`](medical_shared_style.md) and specify the patient’s **left** forearm. The workshop accident is a single self-contained file (also left arm, deep gash).
